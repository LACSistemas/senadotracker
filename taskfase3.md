...
## Q. Testes, reconciliação e entrega
...
| [ ] | F3-095 | F3-044, F3-048, F3-063, F3-064, F3-065, F3-089, F3-090, F3-135 | Executar reconciliação final com SQLite e PostgreSQL | Contagens e somas do banco batem com arquivos/fontes e consultas do frontend; proposições enriquecidas, votos, concordância e fidelidade partidária reconciliam com os lotes ativos nas duas bases durante o corte |
| [ ] | F3-096 | F3-057, F3-058, F3-059, F3-068, F3-069, F3-091, F3-107, F3-135 | Criar E2E da arquitetura da Fase 3 | Eleições, gabinetes, busca/detalhe enriquecido de proposição, timeline, relações, documentos, votos nominais/partidários, os três modos de comparação, nulos, 404, indisponibilidade e fontes cobertos |
...
| [ ] | F3-098 | F3-091, F3-095, F3-097, F3-103, F3-127, F3-135 | Medir desempenho com os novos volumes | Perfil, proposições, comparação e listagens mantêm orçamento de LCP/CLS/transferência; consultas agregadas evitam N+1 e tabelas longas têm paginação ou limite explícito |
...
16. F3-092 a F3-099 — testes, reconciliação e entrega.

Ao retomar: iniciar **F3-109**, definindo o contrato canônico enriquecido antes de ampliar coletores, banco e interface.
