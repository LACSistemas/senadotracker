...
function href(values:Record<string,string|undefined>,overrides:Record<string,string|number|undefined>={}){const params=new URLSearchParams();for(const [key,value] of Object.entries({...values,...overrides}))if(value!==undefined&&value!=='')params.set(key,String(value));return `/legislativo/rankings/dimensoes?${params}`}
