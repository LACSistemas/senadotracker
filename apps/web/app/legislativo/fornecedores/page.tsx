...
export default async function CongressSuppliersHub({searchParams}:{searchParams:Promise<Params>}){
  ...
  <section className="mt-6 rounded-lg border border-border/70 bg-card p-5">
    <SectionHeading n={2} title="Como os pagamentos se distribuem" subtitle="Todo pagamento a fornecedores ligado ao Congresso, somando despesas de gabinete e contratos institucionais de Câmara e Senado, numa única classificação, sem dividir por universo primeiro."/>
